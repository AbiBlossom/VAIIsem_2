...
class AuthController extends AControllerRedirect
{
    ...
    public function register()
    {
        ...
        $newLogin->setText($this->request()->getValue('text'));
        $newLogin->setCity($this->request()->getValue('city'));
        $newLogin->setAddress($this->request()->getValue('address'));
        $newLogin->setImage($this->request()->getValue('image'));
        $newLogin->save();
